...
import { PencilIcon, TrashIcon, EllipsisVerticalIcon, HandThumbUpIcon, ChatBubbleBottomCenterTextIcon, ArrowDownTrayIcon } from '@heroicons/vue/20/solid'
        ...
        <div class="grid gap-3 mb-3" :class="[
            ...
            <template v-for="(attachment, ind) of post.attachments.slice(0, 4)">
                <div class="group aspect-square bg-blue-100 flex flex-col items-center justify-center text-gray-500 relative">
                    <div v-if="ind === 3 && post.attachments.length > 4" class="absolute left-0 right-0 top-0 bottom-0 z-10 bg-black/60 text-white flex items-center justify-center text-2xl">
